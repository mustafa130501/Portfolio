...
export const skillsSection = {
	title: "Ne Yaptım",
	subTitle:
		"Junior Full Stack Developer. I am currently working on my portfolio and learning new technologies.",
	skills: [
		emoji(
	...
	softwareSkills: [
		...
		// {
		// 	skillName: ".net core",
		// 	fontAwesomeClassname: "logos:windows-icon",
		// },
		// {
		// 	skillName: ".net",
...
export const educationInfo = [
	{
		schoolName: "Ankara Yıldırım Beyazıt Üniversity",
		subHeader: "Computer ",
